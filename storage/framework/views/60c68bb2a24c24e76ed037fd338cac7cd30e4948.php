<p class="service-page__placeholder">
    Здесь будет текст страницы «<?php echo e($service['title']); ?>».
</p>
<p class="service-page__hint">
    Создайте файл и напишите свой текст:
    <code>resources/views/pages/service/content/<?php echo e($slug); ?>.blade.php</code>
</p>
