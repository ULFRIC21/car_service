...
<div class="mb-2">
    ...
    <?php if(!empty($service->image_path)): ?>
        <div class="mb-2">
            <img src="<?php echo e($service->image_url); ?>" alt="" class="rounded" style="max-height: 120px; max-width: 100%; object-fit: cover;">
            <p class="small text-muted mb-0">В БД: <code><?php echo e($service->image_path); ?></code></p>
        </div>
    <?php endif; ?>
    ...
    <input type="text" name="image_path" class="form-control mt-1" placeholder="или укажите имя файла вручную"
           value="<?php echo e(old('image_path', $service->image_path ?? '')); ?>">
</div>
<div class="mb-2">
    <label>Цена *</label>
