    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                ...
                <p class="small mb-0">Полный спектр услуг по ремонту и обслуживанию автомобилей. Официальная гарантия на работы.</p>
            </div>
            <div class="col-md-4">
                <h6>Клиентам</h6>
            ...
            <div class="col-md-4">
                <h6>Контакты</h6>
                <p class="small mb-1"><i class="bi bi-telephone me-2"></i><a href="tel:+74951234567">+7 (495) 123-45-67</a></p>
        ...
        <p class="small text-center mb-0">&copy; {{ date('Y') }} {{ config('app.name', 'АвтоМастер') }}. Все права защищены.</p>
    </div>
</footer>
