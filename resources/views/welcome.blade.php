...
@php
    $imgs = config('site.images');
    $serviceImgs = config('site.service_images');
@endphp
            ...
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-2 mb-0">
                    ...
                    @else
                        ...
                        <a href="{{ route('callback.create') }}" class="btn btn-lg btn-outline-light">Заказать звонок</a>
                    @endauth
                </div>
            ...
            <div class="col-lg-5 d-none d-lg-block">
                <div class="as-hero-collage">
                    <div class="as-hero-collage-sm as-hero-collage-sm--tl">
                        <img src="{{ $imgs['engine'] }}" alt="Ремонт двигателя" loading="lazy" width="200" height="200">
                    </div>
                    <div class="as-hero-collage-main">
                        <img src="{{ $imgs['mechanic'] }}" alt="Мастер в автосервисе" loading="lazy" width="500" height="375">
                    </div>
                    <div class="as-hero-collage-sm as-hero-collage-sm--br">
                        <img src="{{ $imgs['brakes'] }}" alt="Тормозная система" loading="lazy" width="180" height="180">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            @forelse($services as $index => $service)
                @php $img = $serviceImgs[$index % count($serviceImgs)]; @endphp
                <div class="col-md-6 col-lg-4">
                    <article class="as-card as-service-card">
                        <div class="as-card-img">
                            <img src="{{ $img }}" alt="{{ $service->name }}" loading="lazy" width="400" height="250">
                            @if($index === 0)
        ...
        <div class="text-center mt-5">
            <a href="{{ route('public.services') }}" class="btn as-btn-cta px-4">Все услуги и цены</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="as-feature-split">
            <div class="as-feature-split-img">
                <img src="{{ $imgs['workshop'] }}" alt="Бокс автосервиса АвтоМастер" loading="lazy" width="600" height="450">
            </div>
            <div>
                ...
                <a href="{{ route('callback.create') }}" class="btn as-btn-outline mt-2">Получить консультацию</a>
            </div>
        </div>
    </div>
</section>
...
<section class="as-section">
    <div class="container">
        ...
        <div class="as-gallery">
            @foreach(config('site.gallery') as $i => $item)
                ...
                <div class="col-md-6">
                    <div class="as-promo as-promo-with-img h-100">
                        <div class="as-promo-img d-none d-md-block">
                            <img src="{{ $imgs['car'] }}" alt="" loading="lazy" width="140" height="100">
                        </div>
                        <div>
                            <h5 class="fw-bold mb-2">{{ $promo->title }}</h5>
                            <p class="mb-3 opacity-90">{{ $promo->body }}</p>
                            <a href="{{ route('public.promotions') }}" class="btn btn-light btn-sm fw-semibold">Все акции</a>
                        </div>
                    </div>
                </div>
            @endforeach
